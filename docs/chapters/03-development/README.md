...
| 章节 | 内容 | 状态 |
|------|------|------|
| 01 设计规范 | 架构文档、时序图、ER 图 | 📋 |
| 02 API 契约 | Markdown 接口文档标准 | 🟡 已在测试篇可复用 |
| 03 代码规范 | 命名、注释、结构 | 📋 |
| 04 代码评审 | 评审清单、标准、流程 | 📋 |
| 05 分支策略 | Git Flow / Trunk-Based | 📋 |
| 06 版本管理 | 版本号、变更日志、Tag | 📋 |
| 07 依赖管理 | 锁定、升级、漏洞处理 | 📋 |
| 08 开发 ↔ 业务 / 测试契约 | 详见测试篇 dev-contract | 🟡 |
| 09 AI 辅助开发 | Claude 代码评审、文档补全 | 📋 |
